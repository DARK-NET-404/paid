...
time.sleep(0.3)
print(f"{YELLOW}       SMS BOMBER TOOL - {RESET}")
time.sleep(0.3)
print(f"{RED}============================================{RESET}")
time.sleep(0.3)
print()
print(f"{YELLOW}          Developed by: {YELLOW}khalidxAhmed{RESET}")
time.sleep(0.3)
...
time.sleep(0.3)
print()
os.system('espeak -a 150 "Welcome bro, SMS Bomber Tool,"')
...
print(f"\n{GREEN}[✓] Completed! Sent {limit} requests to {target}{RESET}")
